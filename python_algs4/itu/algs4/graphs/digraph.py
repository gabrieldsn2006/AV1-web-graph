...
class Digraph:
    ...
    def __init__(self, V, first_index=0):
        """Initializes an empty graph with V vertices and 0 edges. param V the
        number of vertices.

        :param V: number of vertices
        :param first_index: first index of adj list
        ...
        self._indegree = [0] * (V+first_index)  # indegree[v] = indegree of vertex v

        for _ in range(V+first_index):
    ...
    def _validateVertex(self, v):
        ...
        if v < 0+self._first_index or v > self._V+self._first_index:
    ...
    def add_edge(self, v, w):
        ...
        self._indegree[w] += 1  # increment indegree of w
        self._E += 1
    ...
    def degree(self, v):
        self._validateVertex(v)
        return self._adj[v].size() + self._indegree[v]
